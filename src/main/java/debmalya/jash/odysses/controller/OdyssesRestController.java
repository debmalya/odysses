...
public class OdyssesRestController {
  ...
  @Operation(
      description = "QUESTION 2 - Find the best plan",
      summary =
          "Find the combination of plans that offers all selected features at the lowest price.")
  public ResponseEntity<OdyssesResponse> featureSelection(
      @RequestPart("planFile") MultipartFile planFile, @RequestParam("feature") String feature) {
