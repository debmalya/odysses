...
public class OdyssesRestController {
  ...
  @Operation(
      ...
      summary =
          "Find the combination of plans that offers all requested features at the lowest price.")
  public ResponseEntity<OdyssesResponse> featureSelection(
      @RequestPart(name = "planFile", required = true) MultipartFile planFile,
      @RequestParam(name = "feature", defaultValue = "email,voice,admin", required = true)
          String feature) {
